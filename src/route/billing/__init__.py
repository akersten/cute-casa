...
def init_routes(flask_app: Flask):
    ...
    flask_app.add_url_rule("/billing/billsplit",
                           "billing_billsplit",
                           methods=["GET", "POST"],
                           view_func=billing.billsplit)

    flask_app.add_url_rule("/billing/billsplit_create",
                           "billing_billsplit_create",
                           methods=["POST"],
                           view_func=billing.billsplit_create)
